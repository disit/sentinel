...
# last_log_IOT_Device_FeedAndUpdate_DashboardWizard_OS=$(grep -o "Ingestion progress: [0-9]\+%" /var/www/html/dashboardSmartCity/ScheduledTasks/feed-iot-os.log | tail -n 1)
