...
(8,'dashboarddb','if nc -z geoserver-db 3306; then echo \'Success <svg width="12" height="12" style="vertical-align: middle;"><circle cx="6" cy="6" r="6" fill="green"/></svg>\'; else echo \'Failure <svg width="12" height="12" style="vertical-align: middle;"><circle cx="6" cy="6" r="6" fill="red"/></svg>\'; fi; date "+%F at %H:%M:%S"','nc -z -v  localhost 3306'),
...
(10,'geoserver-db','if nc -z geoserver-db 5432; then echo \'Success <svg width="12" height="12" style="vertical-align: middle;"><circle cx="6" cy="6" r="6" fill="green"/></svg>\'; else echo \'Failure <svg width="12" height="12" style="vertical-align: middle;"><circle cx="6" cy="6" r="6" fill="red"/></svg>\'; fi; date "+%F at %H:%M:%S"','nc -v -z localhost 5432'),
...
(21,'ldap-server','if nc -z ldap-server 389; then echo \'Success <svg width="12" height="12" style="vertical-align: middle;"><circle cx="6" cy="6" r="6" fill="green"/></svg>\'; else echo \'Failure <svg width="12" height="12" style="vertical-align: middle;"><circle cx="6" cy="6" r="6" fill="red"/></svg>\'; fi; date "+%F at %H:%M:%S"','nc -v -z localhost 389'),
...
(26,'od-get-api','curl -I -s http://od-insert-api:3100/odmm/api | grep -q \'NOT FOUND\' && echo \'Success <svg width="12" height="12" style="vertical-align: middle;"><circle cx="6" cy="6" r="6" fill="green"/></svg>\' || echo \'Failure <svg width="12" height="12" style="vertical-align: middle;"><circle cx="6" cy="6" r="6" fill="red"/></svg>\'; date "+%F at %H:%M:%S"','curl -I -s $#base-url#$/odmm/api'),
