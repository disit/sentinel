...
--
-- Host: 192.168.1.18    Database: checker
-- ------------------------------------------------------
-- Server version	5.5.5-10.3.32-MariaDB-1:10.3.32+maria~focal
...
CREATE TABLE `component_to_category` (
  ...
  `kind` set('Kubernetes','Docker') NOT NULL DEFAULT 'Kubernetes',
...
CREATE TABLE `cronjobs` (
  ...
  KEY `where_fk` (`where_to_run`),
  CONSTRAINT `category` FOREIGN KEY (`category`) REFERENCES `categories` (`idcategories`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `where_fk` FOREIGN KEY (`where_to_run`) REFERENCES `ip_table` (`hostname`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tests_results` (
  ...
  PRIMARY KEY (`id_test`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 MAX_ROWS=200000;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-11-13 12:58:15
